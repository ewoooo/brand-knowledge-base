...
describe("serializeGraphForPrompt", () => {
  ...
  it("should handle empty graph gracefully", () => {
    const graph: KnowledgeGraph = {
      metadata: { name: "빈 그래프", created: "2026-01-01T00:00:00Z", updated: "2026-01-01T00:00:00Z" },
      nodes: [],
      triples: [],
      rules: [],
    };
  ...
  it("should handle nodes without type", () => {
    const graph: KnowledgeGraph = {
      metadata: { name: "타입 없는 노드", created: "2026-01-01T00:00:00Z", updated: "2026-01-01T00:00:00Z" },
