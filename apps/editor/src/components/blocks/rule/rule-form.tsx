...
export function RuleForm({ open, onClose, onSubmit, nodeTypes, predicates, initial }: RuleFormProps) {
    ...
    const [condition, setCondition] =
        useState<RuleCondition>(DEFAULT_CONDITION);
                ...
                <div className="flex flex-col gap-5 py-2">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <ToggleGroup
                            ...
                            value={ruleType}
                            onValueChange={(v) =>
                                v && setRuleType(v as RuleType)
                            }
                            className="justify-start"
                        >
                            <ToggleGroupItem value="constraint">
                                constraint
                            </ToggleGroupItem>
                            <ToggleGroupItem value="inference">
                                inference
                            </ToggleGroupItem>
                            <ToggleGroupItem value="validation">
                                validation
                            </ToggleGroupItem>
                        </ToggleGroup>
                    </div>
                    ...
                    {expression && (
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="bg-muted overflow-x-auto rounded-md px-4 py-3 font-mono text-sm">
                                {expression}
                            </div>
                        </div>
                    )}
